...
| FUN-103 | Gebühren erfassen und Bescheiddaten bilden | Vorgang/Gebühren; Sachbearbeitung/Kasse | Erwerb/Verlängerung, Beisetzungs-/freie Gebühren, Menge, Betrag, Kontierung, Fälligkeit → Bescheid-/Buchungsgrundlage | W006, W021, buch; W021 40×127 ab Byte 385, Gebührennummer relativ 73/L4 bestätigt; 5.556/L8 technisch als `ddMMyyyy`-Fälligkeitsdatumskandidat profiliert | Positionen 1–8 belegt, 9–40 initialisiert; Betrag und fachliche Rollenbindung des Fälligkeitskandidaten offen | MAN-EDW-103, DAT-001/012/016, Phase-3-/Phase-4-Profil; Block/Referenz/Datumstyp `BESTÄTIGT`, Rest `OFFEN`; hoch; M/S/K offen | Was berechnet EDWALT, was das Finanzsystem, und wann gilt eine Sollstellung? |
