...
|---|---|---|---|---|---|---|---|
| FUN-100 | Grabstätte neu anlegen | Grabverwaltung/Neu; Sachbearbeitung | Friedhof/Grabnummer, Berechtigte, Suchcodes, Grabart, Maße, Kapazität, Nutzung → Grabstamm | W020, W005; Grabart belegt Werte vor | W020 2026 nur Nutzungsindiz; Schlüssel-/Lagekonzept hoch migrationsrelevant | MAN-EDW-100, DAT-015; ANNAHME; hoch; M/S/K offen | Wie wird die Grabnummer gebildet, validiert und bei Strukturänderung erhalten? |
| FUN-101 | Vorgang, verstorbene Person und Beisetzung | Grab/Vorgang; Sachbearbeitung | Vorgangsart, Nutzungszeit, Personen-/Sterbe-/Trauerfeier-/Beisetzungsdaten → Vorgang/Belegung | W021, Auswahlwerte, Grabart; Ruhefristindiz | besonders schützenswerte Ereignisdaten; W021 2026 nur Indiz | MAN-EDW-101, DAT-016; ANNAHME; hoch; M/S/K offen | Welche Vorgangsarten, Pflichtnachweise, Fristregeln und Mehrfachbelegungen gelten? |
...
| FUN-103 | Gebühren erfassen und Bescheiddaten bilden | Vorgang/Gebühren; Sachbearbeitung/Kasse | Erwerb/Verlängerung, Beisetzungs-/freie Gebühren, Menge, Betrag, Kontierung, Fälligkeit → Bescheid-/Buchungsgrundlage | W006, W021, buch; Druck kann Sollstellung auslösen | Berechnungs-/Finanzhoheit offen; keine Regel als Cemaris-Anforderung übernehmen | MAN-EDW-103, DAT-001/012/016; ANNAHME; hoch; M/S/K offen | Was berechnet EDWALT, was das Finanzsystem, und wann gilt eine Sollstellung? |
...
| FUN-109 | Grabnummer/Friedhof/Feld ändern | Bearbeiten; berechtigte Sachbearbeitung | neue Identifikation + Bestätigung → Umnummerierung | W020 mit abhängigen Vorgängen/Dokumenten | führender Schlüssel und Referenzfortschreibung migrationskritisch | MAN-EDW-203, DAT-015/016; ANNAHME; hoch; M/S/K offen | Bleibt eine unveränderliche interne ID bestehen und welche Historie wird protokolliert? |
