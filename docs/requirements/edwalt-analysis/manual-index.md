...
| --- | --- | --- | --- | --- | --- | --- |
| `MAN-EDW-100` | Neue Grabstätte: Grundfenster | `_Toc496520380`, Abs. 1278-1392 | `IMG-EDW-130` | Friedhof und Grabnummer, Nutzungsberechtigtenadresse, Suchcodes, Grabname/-art, Sarg-/Urnenstellen, Fläche/Maße, Erstnutzung/Nutzungsende | Grabart vorbelegt Kapazitäten/Fristen; `W020` | Wie wird die räumliche Grabnummer aufgebaut und validiert? |
| `MAN-EDW-101` | Vorgang, Verstorbene und Beisetzung | `_Toc496520381`, Abs. 1393-1570 | `IMG-EDW-131` bis `IMG-EDW-133` | Vorgangsart, Nutzungszeitraum, Personendaten, Trauerfeier, Stelle/Tiefe, Beisetzungsart/-termin, Ruhefrist, Bestatter, Suchcode | Auswahlwerte und Grabart; `W021` | Welche Vorgangsarten/Fristregeln gelten heute tatsächlich? |
...
| `MAN-EDW-203` | Friedhof/Feld/Grab-Nummer ändern | `_Toc496520395`, Abs. 2053-2064 | `IMG-EDW-149` | Umnummerierung mit Bestätigung | Schlüsseländerung betrifft Beziehungen | Wie werden Referenzen, Dokumente und Historie fortgeschrieben? |
